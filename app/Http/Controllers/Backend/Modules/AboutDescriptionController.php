...
class AboutDescriptionController extends BackendController
{
    ...
    public function index()
    {
        ...
        return view(backendModuleViewUrl('about-description.index'))->with([
            'modules' => Module::all(),
            'data' => AboutDescription::get()->first()
        ]);
    }
