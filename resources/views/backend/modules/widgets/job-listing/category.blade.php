            ...
            <div class="row">
                                    ...
                                    @foreach($categories as $key => $category)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                {!! btnDelete('module/' . $module->id . '/job-listing/category', $category->id) !!}
                                            </td>
                                        </tr>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="content">
                            {!! openFormCreate('module/' . $module->id . '/job-listing/category') !!}
                            <div class="row">
                                <div class="col-md-12">
...
@section('modal')
    ...
    <form data-action="{{ backendUrl('module/' . $module->id .'/job-listing/category') }}"
          id="formEditCategory"
          method="post"
