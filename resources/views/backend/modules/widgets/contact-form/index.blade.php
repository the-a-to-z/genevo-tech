...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            @if($data)
            {!! openFormEdit(config('module.widget.contact-form.url'), $data->id) !!}
            @else
            {!! openFormCreate(config('module.widget.contact-form.url')) !!}
            @endif
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        @section('text-editor')
                                            @parent
                                        @endsection
                                        {!! textEditor('response_message', ($data ? $data->response_message : '')) !!}
